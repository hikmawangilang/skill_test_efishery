...
//Share
WebUI.click(findTestObject('Object Repository/Media Player/share'))

//Wait Pop-up Present
WebUI.waitForElementPresent(findTestObject('Object Repository/Media Player/pop-up'), 0)

//Verify Pop-up Present
WebUI.verifyElementPresent(findTestObject('Object Repository/Media Player/urlShare'), 0)

// Click Social Media
WebUI.click(findTestObject('Object Repository/Media Player/iconSocMed'))
