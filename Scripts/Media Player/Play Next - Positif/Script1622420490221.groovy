...
//Play Next
WebUI.click(findTestObject('Object Repository/Media Player/playNext'))

//Wait Notif Present
WebUI.waitForElementPresent(findTestObject('Object Repository/Media Player/notifPlayNext'), 0)
