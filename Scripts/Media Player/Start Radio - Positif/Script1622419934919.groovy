...
//Start Radio
WebUI.click(findTestObject('Object Repository/Media Player/startRadio'))

//Wait Notif Present
WebUI.waitForElementPresent(findTestObject('Object Repository/Media Player/notifStartingRadion'), 0)
