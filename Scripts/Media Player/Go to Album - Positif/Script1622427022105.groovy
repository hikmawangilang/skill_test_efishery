...
//Go to Album
WebUI.click(findTestObject('Object Repository/Media Player/gotoAlbum'))

//Wait Album Name Present
WebUI.waitForElementPresent(findTestObject('Object Repository/Media Player/detailAlbum'), 0)

//Verify Detail Album Present
WebUI.verifyElementPresent(findTestObject('Object Repository/Media Player/detailAlbum'), 0)
