...
//Go to Artist
WebUI.click(findTestObject('Object Repository/Media Player/gotoArtist'))

//Wait Detail Artist Present
WebUI.waitForElementPresent(findTestObject('Object Repository/Media Player/artistName'), 0)

//Verify Detail Album Present
WebUI.verifyElementPresent(findTestObject('Object Repository/Media Player/artistName'), 0)
