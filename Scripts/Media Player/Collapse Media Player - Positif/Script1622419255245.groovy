...
//Collapse Media Player
WebUI.click(findTestObject('Object Repository/Media Player/collapseExpandBtn'))

//Wait Element Present
WebUI.waitForElementPresent(findTestObject('Object Repository/Media Player/miniBannerMedia'), 0)
