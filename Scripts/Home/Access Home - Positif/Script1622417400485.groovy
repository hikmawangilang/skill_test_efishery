...
//
////Input Password
//WebUI.setText(findTestObject('Object Repository/fieldPassSignIn'), 'BADAKcula98')
//
////Click Button Next
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Home/contentSection'), 0)

//Verify another Content Section Present
WebUI.verifyElementPresent(findTestObject('Object Repository/Home/contentSection2'), 0)
