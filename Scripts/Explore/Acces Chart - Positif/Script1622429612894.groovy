...
//Verify Chart Content Present
WebUI.verifyElementPresent(findTestObject('Object Repository/Explore/carouselChart'), 0)

//Verify Chart Content Present
WebUI.verifyElementPresent(findTestObject('Object Repository/Explore/sectionTopArtists'), 0)
