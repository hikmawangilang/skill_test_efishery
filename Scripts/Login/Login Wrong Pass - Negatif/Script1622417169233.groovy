...
//Input Password
WebUI.setText(findTestObject('Object Repository/fieldPassSignIn'), 'BADAK')

//Click Button Next
WebUI.click()(findTestObject('Object Repository/btnNextPass'))

//Verify Error Message present
WebUI.verifyElementPresent(findTestObject(findTestObject('Object Repository/errorMsgPass')), 0)
